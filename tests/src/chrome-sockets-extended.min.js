...
this._onceReturnValue:!0};c._getEvents=function(){return this._events||(this._events={})};a.noConflict=function(){return e.EventEmitter=f,a};"function"==typeof define&&define.amd?define(function(){return a}):"object"==typeof module&&module.exports?module.exports=a:this.EventEmitter=a}).call(this);var e={tcp:{},udp:{},tcpServer:{}};chrome.socketsExtended.tcp.open=function(a,b){chrome.sockets.tcp.create(a,function(a){var c=new k(a.socketId);c.on("closed",m);e.tcp[a.socketId]=c;b(c)})};chrome.socketsExtended.tcpServer.open=
function(a,b){chrome.sockets.tcpServer.create(a,function(a){var c=new l(a.socketId);c.on("closed",m);e.tcpServer[a.socketId]=c;b(c)})};chrome.socketsExtended.udp.open=function(a,b){chrome.sockets.udp.create(a,function(a){var c=new g(a.socketId);c.on("closed",m);e.udp[a.socketId]=c;b(c)})};chrome.socketsExtended.tcp.closeAll=function(a){chrome.sockets.tcp.getSockets(function(b){for(var d=0;d<b.length;d++)chrome.sockets.tcp.close(b[d].socketId);a&&a()})};chrome.socketsExtended.udp.closeAll=function(a){chrome.sockets.udp.getSockets(function(b){for(var d=
0;d<b.length;d++)chrome.sockets.udp.close(b[d].socketId);a&&a()})};chrome.socketsExtended.tcpServer.closeAll=function(a){chrome.sockets.tcpServer.getSockets(function(b){for(var d=0;d<b.length;d++)chrome.sockets.tcpServer.close(b[d].socketId);a&&a()})};var m=function(){e[this.type][this.socketId]=null;delete e[this.type][this.socketId];this.removeAllListeners()};chrome.sockets.tcp.onReceive.addListener(function(a){var b=a.socketId;e.tcp[b]&&e.tcp[b].emit("receive",a)});chrome.sockets.tcp.onReceiveError.addListener(function(a){a&&
a.socketId&&e.tcp[a.socketId]&&e.tcp[a.socketId].emit("receiveError",a.resultCode)});chrome.sockets.udp.onReceive.addListener(function(a){e.udp[a.socketId]&&e.udp[a.socketId].emit("receive",a)});chrome.sockets.udp.onReceiveError.addListener(function(a){a&&a.socketId&&e.udp[a.socketId]&&e.udp[a.socketId].emit("receiveError",a.resultCode)});chrome.sockets.tcpServer.onAccept.addListener(function(a){if(e.tcpServer[a.socketId]){var b=new k(a.clientSocketId);b.on("closed",m);e.tcp[a.clientSocketId]=b;e.tcpServer[a.socketId].emit("accept",
...
b)};g.prototype.setMulticastTimeToLive=function(a,b){chrome.sockets.udp.setMulticastTimeToLive(this.socketId,a,b)};g.prototype.setMulticastLoopbackMode=function(a,b){chrome.sockets.udp.setMulticastLoopbackMode(this.socketId,a,b)};g.prototype.getJoinedGroups=function(a){chrome.sockets.udp.getJoinedGroups(this.socketId,a)};var l=function(a){f.call(this,"tcpServer");this.socketId=a};l.prototype=Object.create(f.prototype);l.prototype.listen=function(a,b,d){chrome.sockets.tcpServer.listen(this.socketId,
a,b,d)};l.prototype.disconnect=function(a){chrome.sockets.tcpServer.disconnect(this.socketId,a)};chrome.socketsExtended._classes.ChromeTcpSocket=k;chrome.socketsExtended._classes.ChromeUdpSocket=g;chrome.socketsExtended._classes.ChromeTcpServerSocket=l})(window);